...
function addProjectSection() {
    const projects = [
        ...
        },
        {
            ...
            description: "A mobile app for event attendees to turn for the agenda, profiles, and to connect with others.",
        },
        {
            imageLink: "images/insigniahiring.png",
            description: "Landing page and quiz web app for Insignia's tech hiring program.",
        },
        {
            url: "https://play.google.com/store/apps/details?id=com.minpairs", 
            imageLink: "images/minpairs.png",
            description: "An Android app to help improve English listening with minimal pairs.",
        },
        {
            url: "https://play.google.com/store/apps/details?id=com.pcards", 
            imageLink: "images/pcards.png",
            description: "An Android app to help learn English phonetics with flashcards.",
        },
        {
            url: "https://drive.google.com/file/d/1Tpoese8_Yxvl2PrHPCIOIcXZ1mnbGYnB/view?usp=drive_open", 
        ...
        },
        {
            ...
            description: "Tourist site for Da Nang, my final project in Design 101 course.",
        },
        {
        ...
        <div class="div${index + 1}">
            <div class="project-container">
                ${project.url ? `<a  href="${project.url}" target="_blank">` : ""}
                    <img class="project-image" src="${project.imageLink}" alt="${project.imageLink.split(".")[0]}">
                    <div class="overlay">
                        <p class="project-description">${project.description}</div>
                    </div>
                ${project.url ? `</a>` : ""}
            </div>           
        </div>
    `).join("")
    document.getElementById("content").innerHTML = projectHTML + document.getElementById("content").innerHTML;
}
